...
<%
String filePath = "C:\\Users\\LENOVO\\eclipse-workspace\\SwarkimyaPublication\\src\\main\\webapp\\images\\"; // Ensure it ends with a backslash
File file;
    ...
    try { 
        ...
        while (i.hasNext()) {
            ...
            if (!fi.isFormField()) {
                ...
                response.sendRedirect("addcounseling.jsp");
            }
        }
        out.println("</body>");
        out.println("</html>");
