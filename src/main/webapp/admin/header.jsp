  ...
  Swarkimya Publications
    ...
    <div class="collapse navbar-collapse" id="collapsibleNavbar">
      <ul class="navbar-nav">
        ...
        <li class="nav-item">
          <a class="nav-link" href="addcources.jsp">Add Cources</a>
        </li>
        <li class="nav-item">
          <a class="nav-link" href="addcounseling.jsp">Add Counseling</a>
        </li>
        
        <li class="nav-item">
          <a class="nav-link" href="viewfeedback.jsp">Feedbacks</a>
        </li>
        <li class="nav-item">
          <a class="nav-link" href="reports.jsp">Reports</a>
        </li>
         <li class="nav-item">
          <a class="nav-link" href="../admin/logout.jsp">Log out</a>
        </li>
      </ul>
    </div>
  </div>
