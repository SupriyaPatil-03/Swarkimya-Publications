...
<body>
    <div class="container">
        ...
        <%
            ...
            // Retrieve payment method from the query parameters
            String paymentMethod = request.getParameter("paymentMethod");
            if (paymentMethod == null) paymentMethod = "Offline Payment";

            try {
                // Query the latest payment record for the logged-in user
        ...
        <div class="receipt">
            ...
            <p class="receipt-item"><span>Payment Method:</span> <%= paymentMethod %></p>
            <p class="receipt-item"><span>Amount Paid:</span> ₹<%= amount %></p>
            <p class="receipt-item"><span>Payment Date:</span> <%= paymentDate %></p>
        </div>

        <%
            // Display a thank-you message based on the payment method
            if ("Razorpay".equalsIgnoreCase(paymentMethod)) {
        %>
            <p class="thank-you">Thank you for your payment! Your transaction has been successfully processed.</p>
        <%
            } else {
        %>
            <p class="thank-you">Thank you. <br>We look forward to serving you again at Swarkimya Publications.</p>
        <%
            }
        %>
