  ...
  Swarkimya Publications
    ...
    <div class="collapse navbar-collapse" id="collapsibleNavbar">
      <ul class="navbar-nav">
        ...
        <li class="nav-item">
          <a class="nav-link" href="gal.jsp">Books Gallery</a>
        </li>
        <li class="nav-item">
          <a class="nav-link" href="course.jsp">Handwriting Courses</a>
        </li>
        <li class="nav-item">
          <a class="nav-link" href="counseling.jsp">Counseling Sessions</a>
        </li>
        <li class="nav-item">
